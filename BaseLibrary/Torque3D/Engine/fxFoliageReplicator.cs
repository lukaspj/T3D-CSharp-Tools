...
namespace Torque3D
{
	public unsafe class fxFoliageReplicator : SceneObject
	{
      ...
      #region Properties
         ...
         {
         	get { return new LinearColorF(getFieldValue("PlacementColour")); }
         ...
         {
         	get { return float.Parse(getFieldValue("AmbientModulationBias")); }
         	set { setFieldValue("AmbientModulationBias", value.ToString()); }
         }

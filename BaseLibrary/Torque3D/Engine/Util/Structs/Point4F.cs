...
namespace Torque3D.Util
{
   ...
   public class Point4F
   {
    ...
    public class RotationF : Point4F
    {
        public RotationF(float x, float y, float z, float w) : base(x, y, z, w)
        {
        }

        public RotationF(string data) : base(data)
        {
        }

        public RotationF(float[] data) : base(data)
        {
        }

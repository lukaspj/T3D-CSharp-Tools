...
namespace Torque3D.Util
{
   ...
   public class EulerF : Point3F
   {
      public EulerF(float x, float y, float z) : base(x, y, z)
      {
      }

      public EulerF(float[] data) : base(data)
      {
      }

      public EulerF(string data) : base(data)
      {
      }

      internal EulerF(InternalPoint3FStruct point3FStruct) : base(point3FStruct)
      {
      }
   }
}

...
namespace Torque3D
{
	public unsafe class ScatterSky : SceneObject
	{
         	...
         	if (_applyChangesFunc == null)
         	{
         		_applyChangesFunc =
         			(_applyChanges)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_ScatterSky_applyChanges"), typeof(_applyChanges));
         	}
      ...
      #region Properties
         ...
         {
         	get { return new LinearColorF(getFieldValue("Colorize")); }
         ...
         {
         	get { return new LinearColorF(getFieldValue("SunScale")); }
         	set { setFieldValue("SunScale", value.ToString()); }
         }
      
         public LinearColorF AmbientScale
         {
         	get { return new LinearColorF(getFieldValue("AmbientScale")); }
         	set { setFieldValue("AmbientScale", value.ToString()); }
         }
      
         public LinearColorF FogScale
         {
         	get { return new LinearColorF(getFieldValue("FogScale")); }
         ...
         {
         	get { return new LinearColorF(getFieldValue("NightColor")); }
         	set { setFieldValue("NightColor", value.ToString()); }
         }
      
         public LinearColorF NightFogColor
         {
         	get { return new LinearColorF(getFieldValue("NightFogColor")); }
         ...
         {
         	get { return new LinearColorF(getFieldValue("MoonLightColor")); }
         ...
         {
         	get { return new LinearColorF(getFieldValue("ShadowDarkenColor")); }

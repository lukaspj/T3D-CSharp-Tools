...
namespace Torque3D
{
	public unsafe class ParticleEmitterData : GameBaseData
	{
         	...
         	if (_reloadFunc == null)
         	{
         		_reloadFunc =
         			(_reload)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_ParticleEmitterData_reload"), typeof(_reload));
         	}
      ...
      #region Properties
         ...
         {
         	get { return GenericMarshal.StringToBool(getFieldValue("EjectionInvert")); }
         	set { setFieldValue("EjectionInvert", value ? "1" : "0"); }
         }
      
         public bool FadeColor
         {
         	get { return GenericMarshal.StringToBool(getFieldValue("FadeColor")); }
         	set { setFieldValue("FadeColor", value ? "1" : "0"); }
         }
      
         public bool FadeAlpha
         {
         	get { return GenericMarshal.StringToBool(getFieldValue("FadeAlpha")); }
         	set { setFieldValue("FadeAlpha", value ? "1" : "0"); }
         }
      
         public bool FadeSize
         {
         	get { return GenericMarshal.StringToBool(getFieldValue("FadeSize")); }
         	set { setFieldValue("FadeSize", value ? "1" : "0"); }
         }
      
         public bool UseEmitterTransform
         {
         	get { return GenericMarshal.StringToBool(getFieldValue("UseEmitterTransform")); }
         	set { setFieldValue("UseEmitterTransform", value ? "1" : "0"); }
         }
      
         public afxParticlePoolData PoolData
         {
         	get { return Sim.FindObject<afxParticlePoolData>(getFieldValue("PoolData")); }
         	set { setFieldValue("PoolData", value.getId().ToString()); }
         }
      
         public int PoolIndex
         {
         	get { return int.Parse(getFieldValue("PoolIndex")); }
         	set { setFieldValue("PoolIndex", value.ToString()); }
         }
      
         public bool PoolDepthFade
         {
         	get { return GenericMarshal.StringToBool(getFieldValue("PoolDepthFade")); }
         	set { setFieldValue("PoolDepthFade", value ? "1" : "0"); }
         }
      
         public bool PoolRadialFade
         {
         	get { return GenericMarshal.StringToBool(getFieldValue("PoolRadialFade")); }
         	set { setFieldValue("PoolRadialFade", value ? "1" : "0"); }
         }

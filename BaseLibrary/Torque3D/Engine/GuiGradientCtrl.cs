...
namespace Torque3D
{
	public unsafe class GuiGradientCtrl : GuiControl
	{
      ...
      new internal struct InternalUnsafeMethods
      {
         	...
         	if (_getColorCountFunc == null)
         	{
         		_getColorCountFunc =
         			(_getColorCount)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_GuiGradientCtrl_getColorCount"), typeof(_getColorCount));
         	}
         ...
         [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
         private delegate InternalLinearColorFStruct _getColor(IntPtr thisPtr, int idx);
         private static _getColor _getColorFunc;
         internal static InternalLinearColorFStruct getColor(IntPtr thisPtr, int idx)
         {
         	if (_getColorFunc == null)
         	{
         		_getColorFunc =
         			(_getColor)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_GuiGradientCtrl_getColor"), typeof(_getColor));
         	}
      ...
      #region Functions
         ...
         public virtual LinearColorF getColor(int idx)
         {
            return new LinearColorF(InternalUnsafeMethods.getColor(ObjectPtr, idx));
         }
      ...
      #region Properties
         ...
         {
         	get { return new LinearColorF(getFieldValue("PickColor")); }

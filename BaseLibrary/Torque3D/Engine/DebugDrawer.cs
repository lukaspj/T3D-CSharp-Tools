...
namespace Torque3D
{
	public unsafe class DebugDrawer : SimObject
	{
      ...
      new internal struct InternalUnsafeMethods
      {
         ...
         private delegate void _drawLine(IntPtr thisPtr, InternalPoint3FStruct a, InternalPoint3FStruct b, InternalLinearColorFStruct color);
         private static _drawLine _drawLineFunc;
         internal static void drawLine(IntPtr thisPtr, InternalPoint3FStruct a, InternalPoint3FStruct b, InternalLinearColorFStruct color)
         {
         	if (_drawLineFunc == null)
         	{
         		_drawLineFunc =
         			(_drawLine)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_DebugDrawer_drawLine"), typeof(_drawLine));
         	}
         ...
         [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
         private delegate void _drawBox(IntPtr thisPtr, InternalPoint3FStruct a, InternalPoint3FStruct b, InternalLinearColorFStruct color);
         	...
         	if (_setLastTTLFunc == null)
         	{
         		_setLastTTLFunc =
         			(_setLastTTL)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_DebugDrawer_setLastTTL"), typeof(_setLastTTL));
         	}
         	...
         	if (_setLastZTestFunc == null)
         	{
         		_setLastZTestFunc =
         			(_setLastZTest)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_DebugDrawer_setLastZTest"), typeof(_setLastZTest));
         	}
         	...
         	if (_toggleFreezeFunc == null)
         	{
         		_toggleFreezeFunc =
         			(_toggleFreeze)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_DebugDrawer_toggleFreeze"), typeof(_toggleFreeze));
         	}
         	...
         	if (_toggleDrawingFunc == null)
         	{
         		_toggleDrawingFunc =
         			(_toggleDrawing)Marshal.GetDelegateForFunctionPointer(Torque3D.DllLoadUtils.GetProcAddress(Torque3D.Torque3DLibHandle,
         				"fn_DebugDrawer_toggleDrawing"), typeof(_toggleDrawing));
         	}
      ...
      #region Functions
         ...
         public virtual void drawLine(Point3F a, Point3F b, LinearColorF color = null)
         {
            if (color == null) color = LinearColorF.WHITE;

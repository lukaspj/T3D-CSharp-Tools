    ...
    internal class TorqueFunction
    {
        ...
        public string GetParametersString()
        {
            string paramString = Parameters.Aggregate("", (x, y) =>
            {
                ...
                else if (y.Type.DataType == DataType.Struct) x += " = null";
                else if (y.Type.ManagedType.Equals("float") && !y.DefaultValue.EndsWith("f")) x += " = " + y.DefaultValue + "f";
        ...
        public string GetNativeParametersString(bool unicode = true)
        {
